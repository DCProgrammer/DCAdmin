<cfinclude template="_header2.cfm">
<table width="750" border="0" cellspacing="0" cellpadding="10">
  <tr>
    <td bgcolor="#FFFFFF"><p><img src="images/headers/requestinfo.gif" alt="Request Info" width="400" height="25"></p>
      <table width="100%" border="0" cellspacing="0" cellpadding="5">
        <tr valign="top"> 
          ...
          <td bgcolor="f0f0f0">
<table width="100%" border="0" cellspacing="0" cellpadding="5">
              <form method=post action="Form_man_1.cfm">
                <tr valign="top"> 
                  <td align="right">E-mail:</td>
                  <td><input name="email" type="text" class="inputBox" value=""></td>
                </tr>
                <tr valign="top"> 
                  <td align="right">Zip Code:</td>
                  <td><input name="zip" type="text" class="inputBox" value=""></td>
                </tr>
                <tr valign="top"> 
                  <td colspan="2"><hr size="1">
                    Select the products you are interested in purchasing.</td>
                </tr>
                <tr valign="top"> 
                  <td align="right">Auto</td>
                  <td> <input name="isAuto" type="checkbox" class="inputCheckBox2" value="1">
                  </td>
                </tr>
                <tr valign="top"> 
                  <td align="right">Insurance:</td>
                  <td> <input name="isInsurance" type="checkbox" class="inputCheckBox2" id="isInsurance" value="1">
                  </td>
                </tr>
                <tr valign="top"> 
                  <td align="right">Furniture:</td>
                  <td> <input name="isFurniture" type="checkbox" class="inputCheckBox2" value="1">
                  </td>
                </tr>
                <tr valign="top"> 
                  <td align="right">Major Appliance:</td>
                  <td> <input name="isAppliance" type="checkbox" class="inputCheckBox2" value="1">
                  </td>
                </tr>
                <tr valign="top"> 
                  <td colspan="2" align="right">Would you be interested in financing 
                    or re-financing your auto or home.</td>
                </tr>
                <tr valign="top"> 
                  <td align="right">&nbsp;</td>
                  <td> <input name="FinanceInfo" type="checkbox" class="inputCheckBox2" value="1">
                    Yes</td>
                </tr>
                <tr valign="top"> 
