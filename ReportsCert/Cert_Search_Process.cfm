...
<TR>
	...
	<P><CFOUTPUT>Your search for <B>"#Form.Name#"</B> has returned <B>#GetCert.RecordCount#</B> product(s).</CFOUTPUT></P>
	</FONT>
	</TD>
</TR>
...
<TR>
	<TD VALIGN="top">
	<A HREF="Cert_Return.cfm?DealerID=#URLEncodedFormat(GetCert.DealerID)#">#Trim(GetCert.Name)#</A>
	</td>
	<td>&nbsp;</TD>
</TR>
</CFOUTPUT>
